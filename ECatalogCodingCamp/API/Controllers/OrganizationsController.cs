...
namespace API.Controllers
{
    ...
    public class OrganizationsController : BaseController<Organization, OrganizationRepository, int>
    {
        ...
        //[HttpGet("OrganizationData")]
        //public dynamic GetOrganizationData()
        //{
        //    var tokenHandler = new JwtSecurityTokenHandler();
        ...
        //    //var paramsGetOrganizationId = new DynamicParameters();
        //    //paramsGetOrganizationId.Add("CVId", CVId.Result, DbType.Int32);
        //    //var queryOrgId = _dapper.GetAll<int>("[dbo].[SP_RetrieveOrganizationId]", paramsGetOrganizationId, commandType: CommandType.StoredProcedure);
        ...
        //    var queryOrg = _dapper.GetAll<dynamic>("[dbo].[SP_RetrieveOrganization]", paramOrg, commandType: CommandType.StoredProcedure);

        //    var organizationsObj = new
        //    {
        //        Organizations = queryOrg
        //    };
            
        //    return organizationsObj;
        //}
    }
}
