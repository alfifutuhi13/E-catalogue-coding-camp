#pragma checksum "D:\Visual Studio Source\E-catalogue-coding-camp\ECatalogCodingCamp\Client\Views\Candidate\CV.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "517a91da9a069f1f5c45c13fb27ba6117dad3297"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"517a91da9a069f1f5c45c13fb27ba6117dad3297", @"/Views/Candidate/CV.cshtml")]
...
#nullable disable
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "517a91da9a069f1f5c45c13fb27ba6117dad32974651", async() => {
                WriteLiteral(@"
        <!--List Organization-->
        ...
        $(document).ready(function () {
          ...
          ");
                ...
                WriteLiteral(@"         $(`#roleorganization${ij}`).val(`${obj[ij].RoleOrganization}`);
                        ...
                        for (let ik = 1; ik < obj.length; ik++) {
                            if (obj[ik].SkillName == """") {
                                ...
                                $(`#skill${ik}`).val(`${obj[ik].SkillName}`);
                            }
                        }

                        for (let il = 1; il < obj.length; il++");
                WriteLiteral(@") {
                            if (obj[il].WorkName == """") {
                                //nothing to do
                            }
                                ...
                                countWork = il; //increment field counter

                                $(`#work${il}`).val(`${obj[il].WorkName}`);
                            }
                        }
            ...
            $(addButtonSkill).click(function () {
                //check maximum ");
                WriteLiteral(@"number of input fields
            ...
            var addButtonWork = $('.add_buttonWork');//add button Skil");
                WriteLiteral(@"l
