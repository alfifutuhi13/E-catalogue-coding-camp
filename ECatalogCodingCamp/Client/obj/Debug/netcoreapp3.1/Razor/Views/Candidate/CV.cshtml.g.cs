#pragma checksum "C:\Users\alfat\Documents\GitHub\E-catalogue-coding-camp\ECatalogCodingCamp\Client\Views\Candidate\CV.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c90fd20f29be68799fe914e774a16d26e02ee940"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c90fd20f29be68799fe914e774a16d26e02ee940", @"/Views/Candidate/CV.cshtml")]
...
#nullable disable
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c90fd20f29be68799fe914e774a16d26e02ee9404675", async() => {
                WriteLiteral(@"
        <!--List Organization-->
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                WriteLiteral(@"on</label><br /><input id=""organization${ij}"" type=""text"" class=""form-control"" name=""organization${ij}"" value="""" placeholder=""Ex: Himpunan"" required /><br /><div class=""invalid-feedback"">Organization is required</div><label for=""roleorganization${ij}"">Role Organization</label><br /><input id=""roleorganization${ij}"" type=""text"" class=""form-control"" name=""roleorganization${ij}"" value="""" placeholder=""Ex: Ketua"" required /><br /><div class=""invalid-feedback"">Role Organization is required</div> <a href=""javascript:void(0);"" class=""remove_button"">Remove Organization and Role Organization Field</a></div>`); //add field html
                    ...
                    for (let ik = 1; ik < obj.skills.length; ik++) {
                        $(wrapperSkill).a");
                WriteLiteral(@"ppend(`<div><label for=""skill${ik}"">Skill</label><input id=""skill${ik}"" type=""text"" class=""form-control"" name=""skill${ik}"" placeholder=""Ex: Python"" required><br /><div class=""invalid-feedback"">Skill is required</div> <a href=""javascript:void(0);"" class=""remove_button"">Remove Skill Field</a></div>`); //add field html
                    ...
                    for (let il = 1; il < obj.works.length; il++) {
                        ...
                        $(`#work${il");
                WriteLiteral(@"}`).val(`${obj.works[il].WorkName}`);
                    }
            ...
            $(addButtonOrg).click(function () {
                ...
                if (countOrg < maxField) {
                    $(wrapperOrg).append(`<div><label for=""organization${countOrg}"">Organization</label><br /><input id=""organization${countOrg}"" type=""text"" class=""form-control"" name=""organization${countOrg}"" value="""" placeholder=""Ex: Himpunan"" required /><br /><div cl");
                WriteLiteral(@"ass=""invalid-feedback"">Organization is required</div><label for=""roleorganization${countOrg}"">Role Organization</label><br /><input id=""roleorganization${countOrg}"" type=""text"" class=""form-control"" name=""roleorganization${countOrg}"" value="""" placeholder=""Ex: Ketua"" required /><br /><div class=""invalid-feedback"">Role Organization is required</div> <a href=""javascript:void(0);"" class=""remove_button"">Remove Organization and Role Organization Field</a></div>`); //add field html
            ...
            var addButtonSkill = $('.add_buttonSkill');//");
...
");
            ...
            //Once remove button is clicked
            $(wrapperWork).on('click', '.remove_button', fu");
            ...
            let InsertCV = () => {
                ...
                for (let k = 0; k < countWork; k++) {
                    ...
                    Obj.Works[k].WorkName = $(`");
                WriteLiteral(@"#work${k}`).val();
                }
                console.log(Obj);
