#pragma checksum "D:\Visual Studio Source\E-catalogue-coding-camp\ECatalogCodingCamp\Client\Views\Candidate\CV.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "0976ea8e7e244e436e957d4731e1a57608269dae"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"0976ea8e7e244e436e957d4731e1a57608269dae", @"/Views/Candidate/CV.cshtml")]
...
#nullable disable
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "0976ea8e7e244e436e957d4731e1a57608269dae4651", async() => {
                WriteLiteral(@"
        <!--List Organization-->
        ...
        $(document).ready(function () {
            ...
            $(addButtonOrg).click(function () {
                ...
                if (countOrg < maxField) {
                    $(wrapperOrg).append(`<div><label for=""organization${countOrg}"">Organization</label><br /><input id=""organization${countOrg}"" type=""text"" class=""form-control"" name=""organization${cou");
                WriteLiteral(@"ntOrg}"" value="""" placeholder=""Ex: Himpunan"" required /><br /><div class=""invalid-feedback"">Organization is required</div><label for=""roleorganization${countOrg}"">Role Organization</label><br /><input id=""roleorganization${countOrg}"" type=""text"" class=""form-control"" name=""roleorganization${countOrg}"" value="""" placeholder=""Ex: Ketua"" required /><br /><div class=""invalid-feedback"">Role Organization is required</div> <a href=""javascript:void(0);"" class=""remove_button"">Remove Organization and Role Organization Field</a></div>`); //add field html
            ...
            //Skill inputs
            var wrapperSkill = $('.field_wrapperSkill'");
                WriteLiteral(@");//input field wrapper
            ...
            $(wrapperSkill).on('click', '.remove_button', function (e) {
                e.preventDefault();
                $(this).pa");
                WriteLiteral(@"rent('div').remove(); //remove field html
