#pragma checksum "D:\Visual Studio Source\E-catalogue-coding-camp\ECatalogCodingCamp\Client\Views\Candidate\CV.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "36101ae9e668fb5a2f7f2e8bccb073be79eb6166"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"36101ae9e668fb5a2f7f2e8bccb073be79eb6166", @"/Views/Candidate/CV.cshtml")]
...
#nullable disable
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "36101ae9e668fb5a2f7f2e8bccb073be79eb61664651", async() => {
                WriteLiteral(@"
        <!--Id-->
        ...
        <div class=""form-group"">
            <div class=""field_wrapperOrg"">
                ...
                BeginWriteAttribute("value", " value=\"", 608, "\"", 616, 0);
                EndWriteAttribute();
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                WriteLiteral(@"   $(wrapperOrg).append(`<div><label for=""organization${ij}"">Organization</label><br /><input id=""organization${ij}"" type=""text"" class=""form-control"" name=""organization${ij}"" value="""" placeholder=""Ex: Himpunan"" required /><br /><div class=""invalid-feedback"">Organization is required</div><label for=""roleorganization${ij}"">Role Organization</label><br /><input id=""roleorganization${ij}"" type=""text"" class=""form-control"" name=""roleorganization${ij}"" value="""" placeholder=""Ex: Ketua"" required /><br /><div class=""invalid-feedback"">Role Organization is required</div> <a href=""javascript:void(0);"" class=""remove_button"">Remove Organization and Role Organization Field</a></div>`); //add field html
                    ...
                    for (let ik = 1");
                WriteLiteral(@"; ik < obj.skills.length; ik++) {
                    ...
                    for (let il = 1; il < obj.works.length; il++) {
                      ...
                      ");
                WriteLiteral(@"  countWork++; //increment field counter
            ...
            $(addButtonOrg).click(function () {
                ...
                if (countOrg < maxField) {
                    $(wrapperOrg).append(`<div><label for=""organization${countOrg}"">Organization</label><br /><input id=""organization${countOrg}"" type=""text"" class=""for");
                WriteLiteral(@"m-control"" name=""organization${countOrg}"" value="""" placeholder=""Ex: Himpunan"" required /><br /><div class=""invalid-feedback"">Organization is required</div><label for=""roleorganization${countOrg}"">Role Organization</label><br /><input id=""roleorganization${countOrg}"" type=""text"" class=""form-control"" name=""roleorganization${countOrg}"" value="""" placeholder=""Ex: Ketua"" required /><br /><div class=""invalid-feedback"">Role Organization is required</div> <a href=""javascript:void(0);"" class=""remove_button"">Remove Organization and Role Organization Field</a></div>`); //add field html
                    countOrg++; //increment field counter
                }
            });
            ...
            //Skill inputs
            var wrap");
                WriteLiteral(@"perSkill = $('.field_wrapperSkill');//input field wrapper
            ...
            $(""#submit"").click(function () {
              ...
              ");
                WriteLiteral(@"      Obj.Skills[j].SkillName = $(`#skill${j}`).val();
                }
            ...
            let InsertCV = (Obj) => {
                ...
                //    Obj.Organizations[i].OrganizationName = $(`#organization${i}`).val();
                //    Obj.Or");
                WriteLiteral(@"ganizations[i].RoleOrganization = $(`#roleorganization${i}`).val();
                //}
                //for (let j = 0; j < countSkill; j++) {
                //    Obj.Skills[j] = new Object();
            ...
            let UpdateCV = (Obj) => {
                ...
                //    Obj.Organizations[i].RoleOrganization = $(`#roleorganization${i}`).val();
                //}
                //for (let j = 0; j < Obj.Skills.length; j++) {
                //    Obj.Skills[j] = new Object();
                //    Obj.Skills[j].SkillName = $(`#skill${j}`).val();
                //}
                //for (let k = 0; k < Obj.Works.length; k++) {
                //    Obj.Works[k] = new Object();
                //    Obj.Works[k].WorkName = $(`#work${k}`).val();
                //}
                console.log(Obj);
