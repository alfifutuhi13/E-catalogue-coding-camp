#pragma checksum "C:\Users\alfat\Documents\GitHub\E-catalogue-coding-camp\ECatalogCodingCamp\Client\Views\Candidate\CV.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "315e6ec1f2949239fe0e52b23c717db575012729"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"315e6ec1f2949239fe0e52b23c717db575012729", @"/Views/Candidate/CV.cshtml")]
...
#nullable disable
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "315e6ec1f2949239fe0e52b23c717db5750127294766", async() => {
                WriteLiteral(@"
        <!--Id-->
        ...
        <!--List Work-->
        <h5 class=""card-title""><strong>Your Work Experiences</strong></h");
                WriteLiteral(@"5><br />
        <div class=""form-group"">
    ...
    <script>
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                success: (data) => {
                    ...
                    if (obj.organizations.length > 0) {
                        ...
                        for (let ij = 1; ij < obj.organiza");
                WriteLiteral(@"tions.length; ij++) {
                            ...
                            $(`#roleorganization${ij}`).v");
                WriteLiteral(@"al(`${obj.organizations[ij].RoleOrganization}`);
                        }
                    }
            ...
            //Organization Inputs
            var addButtonOrg = $('.a");
                WriteLiteral(@"dd_buttonOrg');//add button Org
            ...
            $(addButtonSkill).click(function () {
                ...
                if (countSkill < maxField) {
                    $(wrapperSkill).append(`<div><br /><a href=""");
          ...
          ");
                WriteLiteral(@"      let checkExist = true;
          ...
          ");
            ...
            let UpdateCV = (Obj) => {
                ...
                $.ajax({
                    ...
                    console.log(result);
");
                WriteLiteral(@"                    alert(""Failed to Add Data!"");
                });
            }
