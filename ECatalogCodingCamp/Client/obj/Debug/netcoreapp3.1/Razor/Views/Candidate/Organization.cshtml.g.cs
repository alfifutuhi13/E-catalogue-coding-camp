#pragma checksum "D:\Visual Studio Source\E-catalogue-coding-camp\ECatalogCodingCamp\Client\Views\Candidate\Organization.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a0600ee00da3cbf135a9e9bad892fa52bfd6a5c6"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a0600ee00da3cbf135a9e9bad892fa52bfd6a5c6", @"/Views/Candidate/Organization.cshtml")]
    ...
    public class Views_Candidate_Organization : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "D:\Visual Studio Source\E-catalogue-coding-camp\ECatalogCodingCamp\Client\Views\Candidate\Organization.cshtml"
...
#nullable disable
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "a0600ee00da3cbf135a9e9bad892fa52bfd6a5c64779", async() => {
                WriteLiteral(@"
        <!--Id-->
    ...
    <script>
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                WriteLiteral(@"gth > 1)
                    ...
                    for (let i = 1; i < obj.organizations.length; i++) {
                        $(wrapperOrg).append(`<div><br /><a href=""javascript:void(0);"" class=""remove_button"" title=""Remove Organization and Role Organization Field""><i class=""fas fa-minus-square""></i></a><br /><input type=""hidden"" class=""form-control"" id=""number${i}"" name=""number${i}""><label for=""organization${i}"">Organization</label><br /><input id=""organization${i}"" type=""text"" class=""form-control"" name=""organization${i}"" value="""" placeholder=""Ex: Himpunan"" required /><br /><div class=""invalid-feedback"">Organization is required</div><label for=""roleorganization${i}"">Role Organization");
                WriteLiteral(@"</label><br /><input id=""roleorganization${i}"" type=""text"" class=""form-control"" name=""roleorganization${i}"" value="""" placeholder=""Ex: Ketua"" required /><br /><div class=""invalid-feedback"">Role Organization is required</div></div>`); //add field html
            ...
            $(wrapperOrg)");
                WriteLiteral(@".on('click', '.remove_button', function (e) {
                e.preventDefault();
...
");
        ...
        let sAlertAdd = () => {
            swal({
                title: ""Done"",
       ");
                WriteLiteral(@"         text: ""Data successfully added."",
                icon: ""success"",
                button: ""Ok"",
            }).then(() => {
