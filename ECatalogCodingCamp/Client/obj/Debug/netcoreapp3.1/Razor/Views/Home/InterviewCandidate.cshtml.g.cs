#pragma checksum "D:\Visual Studio Source\E-catalogue-coding-camp\ECatalogCodingCamp\Client\Views\Home\InterviewCandidate.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "baecdcb8d659a0d6c3788a3a307c258b288a13f4"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"baecdcb8d659a0d6c3788a3a307c258b288a13f4", @"/Views/Home/InterviewCandidate.cshtml")]
...
<div class=""modal fade"" id=""book"" tabindex=""-1"" role=""dialog"" aria-labelledby=""add"" aria-hidden=""true"">
    <div class=""modal-dialog"" role=""document"">
        <div class=""modal-content"">
            ...
            <div class=""modal-body"">
                ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "baecdcb8d659a0d6c3788a3a307c258b288a13f45357", async() => {
                WriteLiteral(@"
    ...
    <script>
        ...
        let getClientById = id => {
            $('#table_id').DataTable({
                ...
                WriteLiteral(@": 'Email' },
                    ...
                    {
                        ""render"": function (data, type, row) {
                            return `<button type=""button"" class=""btn btn-primary"" id=""confirm"" onclick=""confirmFunction(${id})"" title=""Confirm"">Confirm</button>`
                                +
        ...
        let UpdateStatusHired = id => {
            $.ajax({
                url: `UpdateStatusHired/${id}`,
                type: `PUT`,
                data: { ""id"": id },
                dataSrc: """",
                success: result => {
        ...
        let confirmFunction = id => {
            UpdateStatusHired(id);
        }
